Qbitcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/qbitcoin/files/Qbitcoin/qbitcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Qbitcoin
...
New/changed settings (command-line or qbitcoin.conf file)
--------------------------------------------------------
