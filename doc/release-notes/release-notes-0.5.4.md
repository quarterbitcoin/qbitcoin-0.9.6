Qbitcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/qbitcoin/files/Qbitcoin/qbitcoin-0.5.4/
...
http://gitorious.org/qbitcoin/qbitcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Qbitcoin-Qt notifications under Growl 1.3.
Increase required age of Qbitcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxQbitcoin properly when installing Qbitcoin-Qt over it. (Windows)
