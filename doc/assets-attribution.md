The following is a list of assets used in the qbitcoin source and their proper attribution.
...
* License: MIT
* Site: [https://qbitcointalk.org/index.php?topic=15276.0](https://qbitcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original qbitcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/qbitcoin.icns, src/qt/res/src/qbitcoin.svg,
	src/qt/res/src/qbitcoin.ico, src/qt/res/src/qbitcoin.png,
	src/qt/res/src/qbitcoin_testnet.png, docs/qbitcoin_logo_doxygen.png,
