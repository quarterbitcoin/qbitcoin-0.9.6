...
#ifndef H_QBITCOIN_SCRIPT
#define H_QBITCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CQbitcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Qbitcoin always counted CHECKMULTISIGs
