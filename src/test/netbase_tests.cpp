...
{
    BOOST_CHECK(TestSplitHost("www.qbitcoin.org", "www.qbitcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.qbitcoin.org]", "www.qbitcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.qbitcoin.org:80", "www.qbitcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.qbitcoin.org]:80", "www.qbitcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8733", "127.0.0.1", 8733));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8733", "127.0.0.1", 8733));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8733", "::ffff:127.0.0.1", 8733));
    BOOST_CHECK(TestSplitHost("[::]:8733", "::", 8733));
    BOOST_CHECK(TestSplitHost("::8733", "::8733", -1));
    BOOST_CHECK(TestSplitHost(":8733", "", 8733));
    BOOST_CHECK(TestSplitHost("[]:8733", "", 8733));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8733", "127.0.0.1:8733"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8733", "[::]:8733"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
