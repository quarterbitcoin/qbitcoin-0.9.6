...
#ifndef _QBITCOINRPC_CLIENT_H_
#define _QBITCOINRPC_CLIENT_H_ 1
...
/** Show help message for qbitcoin-cli.
 ...
 *
 * @note the argument can be removed once qbitcoin-cli functionality is removed from qbitcoind
 */
