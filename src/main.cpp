...
#if defined(NDEBUG)
# error "Qbitcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Qbitcoin Signed Message:\n";
...
static const int64_t nTargetSpacing = 5 * 60;
...
void ThreadScriptCheck() {
    RenameThread("qbitcoin-scriptch");
