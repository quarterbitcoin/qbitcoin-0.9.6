...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old QbitcoinPullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/QbitcoindComparisonTool_jar/QbitcoindComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/qbitcoin/qbitcoin.git")
...
environ_default("BUILD_PATH", "/mnt/qbitcoin")
...
environ_default("GITHUB_REPO", "qbitcoin/qbitcoin")
