...
unlocked to sign the Qbitcoin-Qt.app bundle.
...
allowing somebody to distribute a Qbitcoin-Qt.app or qbitcoin-qt-setup.exe with a valid
...
that the qbitcoin-qt.exe file inside the installer had not been tampered with.
