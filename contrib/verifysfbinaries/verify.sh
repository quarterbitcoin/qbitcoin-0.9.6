...
WORKINGDIR="/tmp/qbitcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/qbitcoin/Qbitcoin/qbitcoin-0.9.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/qbitcoin/Qbitcoin/"
VERSIONPREFIX="qbitcoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'qbitcoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[qbitcoin-]<version>-[rc[0-9]] (example: qbitcoin-0.7.1-rc1)"
   echo "wget output:"
